...
export class VendorProfile {
  ...
  public Vendorprofile = async (
    ...
    try {
      ...
      entity = await this.resolver.VendorProfileV1(
        request.payload,
        decodedToken
      );
  ...
  public VendorprofilePageData = async (
    ...
    try {
      let entity;
      entity = await this.resolver.VendorprofilePageDataV1(
        request.payload,
        decodedToken
      );
  ...
  public UpdateBasicDetail = async (
    ...
    try {
      ...
      entity = await this.resolver.UpdateBasicDetailV1(
        request.payload,
        decodedToken
      );
  ...
  public VendorBankDetails = async (
    ...
    try {
      let entity;
      entity = await this.resolver.VendorBankDetailsV1(
        request.payload,
        decodedToken
      );
      if (entity.success) {
  ...
  public RestaurentDocUplaod = async (
    ...
    try {
      let entity;
      entity = await this.resolver.RestaurentDocUplaodV1(
        request.payload,
        decodedToken
      );
  ...
  public RestaurentDocUpdate = async (
    ...
    try {
      let entity;
      entity = await this.resolver.RestaurentDocUpdateV1(
        request.payload,
        decodedToken
      );
      if (entity.success) {
  ...
  public deleteRestaurentDoc = async (
    ...
    try {
      let entity;
      entity = await this.resolver.deleteRestaurentDocV1(
        request.payload,
        decodedToken
      );
  ...
  public ViewaddedProduct = async (
    ...
    try {
      let entity;
      entity = await this.resolver.ViewaddedProductV1(
        request.payload,
        decodedToken
      );
  ...
  public userViewProducts = async (
    request: any,
    response: Hapi.ResponseToolkit
  ): Promise<any> => {
    try {
      let entity;
      entity = await this.resolver.UserViewProducts(request.payload);
  ...
  public offersApplied = async (
    ...
    try {
      let entity;
      entity = await this.resolver.offersAppliedV1(
        request.payload,
        decodedToken
      );
  ...
  public getDocuments = async (
    ...
    try {
      let entity;
      entity = await this.resolver.getDocumentsV1(
        request.payload,
        decodedToken
      );
  ...
  public addDocuments = async (
    ...
    try {
      let entity;
      entity = await this.resolver.addDocumentsV1(
        request.payload,
        decodedToken
      );
  ...
  public UpdateDocuments = async (
    ...
    try {
      let entity;
      entity = await this.resolver.UpdateDocumentsV1(
        request.payload,
        decodedToken
      );
  ...
  public getVendorList = async (
    ...
    try {
      let entity;
      entity = await this.resolver.getVendorListV1(
        request.payload,
        decodedToken
      );
  ...
  public UpdatePayment = async (
    ...
    try {
      let entity;
      entity = await this.resolver.UpdatePaymentV1(
        request.payload,
        decodedToken
      );
  ...
  public paymentVisibility = async (
    ...
    try {
      let entity;
      entity = await this.resolver.paymentVisibilityV1(
        request.payload,
        decodedToken
      );
